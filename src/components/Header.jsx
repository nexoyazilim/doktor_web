                ...
                <div className="site-navigation">
                  <div className="site-menubar">
                    <div className="site-branding">
                      <Link className="home-link" to={getLocalizedUrl('home', i18n.language)} title={t('site.brand')} rel="home">
                        <img src={`${import.meta.env.BASE_URL}assets/images/doktor_logo.png`} alt={t('site.brand')} className="logo-img" fetchPriority="high" decoding="async" />
                        <span className="brand-name">{t('site.brand')}</span>
                      </Link>
                    </div>
                    <div className="mobile-cta d-block d-sm-none">
                      <Link className="cmt-btn cmt-btn-size-md cmt-btn-shape-square cmt-btn-style-fill cmt-btn-color-dark d-block d-sm-none" to={`${getLocalizedUrl('contact', i18n.language)}#appointment`} rel="noopener" aria-label="Randevu Al">{t('nav.appointment')}</Link>
                    </div>
                ...
                <ul className="menu">
                  ...
                  >
                    <Link
                      ...
                      onClick={(e) => {
                        ...
                        // Masaüstünde tıklama: doğrudan /tedaviler sayfasına git
                      }}
                      onKeyDown={(e) => {
                        if (e.key === ' ' && window.innerWidth < 992) {
                          e.preventDefault()
                          setIsTreatmentsOpen(v => !v)
                        }
                      }}
                  ...
                  {isMobile ? (
                    ...
                    <li className={"mega-menu-item" + (isGalleryOpen ? " open" : " ")}
                      onMouseLeave={() => { if (window.innerWidth >= 992) setIsGalleryOpen(false) }}
                    >
                      ...
                      <ul className={"mega-submenu" + (isGalleryOpen ? " open" : "") } aria-hidden={!isGalleryOpen}
                        onClick={() => { setIsGalleryOpen(false); setIsTreatmentsOpen(false); setIsMenuOpen(false) }}
                      >
