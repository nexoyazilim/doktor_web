        ...
        <div className="container-fluid">
          <div className="row g-0">
            ...
            <div className="col-sm-12 col-md-12 col-lg-7">
              <div className="row">
                <div className="col-sm-4 col-md-4 col-lg-4 widget-area"><div className="widget widget-recent-post with-title"><h3 className="widget-title">{t('footer.menu')}</h3><ul className="widget_contact_wrapper"><li><p><Link to={getLocalizedUrl('about', i18n.language)} className="footer-link">{t('nav.about')}</Link></p></li><li><p><Link to={getLocalizedUrl('academic', i18n.language)} className="footer-link">{t('nav.academic')}</Link></p></li><li><p><Link to={getLocalizedUrl('treatments', i18n.language)} className="footer-link">{t('nav.specialties')}</Link></p></li><li><p><Link to={getLocalizedUrl('blog', i18n.language)} className="footer-link">{t('nav.blog')}</Link></p></li><li><p><Link to={getLocalizedUrl('photoGallery', i18n.language)} className="footer-link">{t('gallery.photo.title')}</Link></p></li><li><p><Link to={getLocalizedUrl('videoGallery', i18n.language)} className="footer-link">{t('gallery.video.title')}</Link></p></li><li><p><Link to={getLocalizedUrl('contact', i18n.language)} className="footer-link">{t('nav.contact')}</Link></p></li></ul></div></div>
                ...
                <div className="col-sm-4 col-md-4 col-lg-4 widget-area"><div className="widget widget-recent-post with-title"><h3 className="widget-title">{t('footer.specialties')}</h3><ul className="widget_contact_wrapper"><li><p><Link to={getTreatmentUrl('burun-estetigi-rinoplasti', i18n.language)} className="footer-link">{t('nav.treatments.rhinoplasty')}</Link></p></li><li><p><Link to={getTreatmentUrl('meme-buyutme', i18n.language)} className="footer-link">{t('nav.treatments.breastAugmentation')}</Link></p></li><li><p><Link to={getTreatmentUrl('meme-kucultme', i18n.language)} className="footer-link">{t('nav.treatments.breastReduction')}</Link></p></li><li><p><Link to={getTreatmentUrl('liposuction-yag-aldirma', i18n.language)} className="footer-link">{t('nav.treatments.liposuction')}</Link></p></li><li><p><Link to={getTreatmentUrl('karin-germe-abdominoplasti', i18n.language)} className="footer-link">{t('nav.treatments.tummyTuck')}</Link></p></li><li><p><Link to={getTreatmentUrl('yuz-germe', i18n.language)} className="footer-link">{t('nav.treatments.facelift')}</Link></p></li><li><p><Link to={getTreatmentUrl('goz-kapagi-estetigi', i18n.language)} className="footer-link">{t('nav.treatments.eyelidSurgery')}</Link></p></li><li><p><Link to={getTreatmentUrl('botoks-uygulamasi', i18n.language)} className="footer-link">{t('nav.treatments.botox')}</Link></p></li><li><p><Link to={getTreatmentUrl('dolgu-uygulamasi', i18n.language)} className="footer-link">{t('nav.treatments.filler')}</Link></p></li><li><p><Link to={getTreatmentUrl('sac-ekimi', i18n.language)} className="footer-link">{t('nav.treatments.hairTransplant')}</Link></p></li></ul></div></div>
              </div>
            </div>
          </div>
        </div>
