          ...
          <div className="row g-0">
            ...
            <div className="col-sm-12 col-md-12 col-lg-7">
              <div className="row">
                ...
                <div className="col-sm-4 col-md-4 col-lg-4 widget-area"><div className="widget widget-recent-post with-title"><h3 className="widget-title">Uzmanlık Alanları</h3><ul className="widget_contact_wrapper"><li><p><a href="/tedaviler?sec=omurga-cerrahisi" className="footer-link">Omurga Cerrahisi</a></p></li><li><p><a href="/tedaviler?sec=deformite-cerrahisi" className="footer-link">Deformite Cerrahisi</a></p></li><li><p><a href="/tedaviler?sec=endoskopik-omurga-cerrahisi" className="footer-link">Endoskopik Omurga Cerrahisi</a></p></li><li><p><a href="/tedaviler?sec=bel-fitigi" className="footer-link">Bel Fıtığı Ameliyatı</a></p></li><li><p><a href="/tedaviler?sec=bel-kaymasi" className="footer-link">Bel Kayması</a></p></li><li><p><a href="/tedaviler?sec=boyun-fitigi" className="footer-link">Boyun Fıtığı Ameliyatı</a></p></li><li><p><a href="/tedaviler?sec=cocuklarda-skolyoz" className="footer-link">Çocuklarda Skolyoz</a></p></li><li><p><a href="/tedaviler?sec=eriskin-skolyoz" className="footer-link">Erişkin Skolyoz</a></p></li><li><p><a href="/tedaviler?sec=beyin-tumoru" className="footer-link">Beyin Tümörü</a></p></li><li><p><a href="/tedaviler?sec=beyincik-sarkmasi" className="footer-link">Beyincik Sarkması </a></p></li></ul></div></div>
              </div>
            </div>
          </div>
        </div>
